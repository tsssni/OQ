...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_AddFriend_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_AddFriend_t qt_meta_stringdata_AddFriend = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_AddFriend[] = {
...
Q_CONSTINIT const QMetaObject AddFriend::staticMetaObject = { {
    ...
    qt_meta_stringdata_AddFriend.offsetsAndSizes,
    qt_meta_data_AddFriend,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_AddFriend_t,
        // Q_OBJECT / Q_GADGET
